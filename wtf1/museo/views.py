...
def feed(request):
	...
	cursor.execute('''select post_list.pid,post_list.uid,user_list.Name,post_list.content,post_list.upvotes,post_list.downvotes from post_list,user_list where post_list.uid=user_list.uid;''')
	row=cursor.fetchall()
	args['row']=row
...
def profile(request):
	cursor=connection.cursor()
# select post_list.pid,post_list.uid,user_list.Name,post_list.content,post_list.upvotes,post_list.downvotes from post_list,user_list where post_list.uid=user_list.uid;
